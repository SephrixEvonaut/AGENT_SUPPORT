...
export class HumanRandomizer {
     ...
     */
    configureSweetSpots(rangeName, sweetSpotMap) {
     ...
     */
    gaussianBias(value, min, max, rangeName) {
     ...
     */
    historyCorrection(value, rangeName, range) {
     ...
     */
    generate(min, max, rangeName = "default") {
        this.iteration++;
     ...
     */
    generateWeighted(min, max, sweetSpots, rangeName = "default") {
        // Convert to map format
        const sweetSpotMap = new Map();
    ...
    getStats(rangeName) {
        ...
        const sweetSpotHitRate = new Map();
        if (sweetSpotMap) {
 ...
 */
function configureDefaultSweetSpots(randomizer) {
    ...
    randomizer.configureSweetSpots("echo_hit_low", new Map([
    ...
    randomizer.configureSweetSpots("echo_hit_medium", new Map([
    ...
    randomizer.configureSweetSpots("echo_hit_high", new Map([
    ...
    // =========================================================================
    randomizer.configureSweetSpots("buffer_extension", new Map([
 ...
 */
export function getHumanBufferDelay(tier) {
    const ranges = {
        low: [129, 163],
        medium: [229, 263],
        high: [513, 667],
 ...
 */
export function getHumanEchoHitDuration(bufferTier = "low") {
    const ranges = {
 ...
 */
export function calculateBufferExtension(echoCount, bufferTier, bufferMs) {
 ...
 */
export function getRandomizerStats(rangeName) {
    return getRandomizer().getStats(rangeName);
}
export default HumanRandomizer;
//# sourceMappingURL=humanRandomizer.js.map