...
export class InterceptionExecutor {
    context = null;
    keyboardDevice = 1; // Default to first keyboard
    ffi = null;
    initialized = false;
    dllPath;
     ...
     */
    createStrokeBuffer(code, state, isExtended = false) {
    ...
    validateSequence(sequence) {
        ...
        const uniqueKeys = new Set(sequence.filter((s) => s.key).map((s) => s.key.toLowerCase()));
...
//# sourceMappingURL=interceptionExecutor.js.map